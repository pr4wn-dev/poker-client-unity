...
namespace PokerClient.UI.Scenes
{
    ...
    public class AdventureScene : MonoBehaviour
    {
        ...
        private void BuildHeader()
        {
            ...
            levelRow.GetOrAddComponent<LayoutElement>().preferredHeight = 30;
            ...
            playerLevelText.GetOrAddComponent<LayoutElement>().preferredWidth = 100;
            
            playerXPText = UIFactory.CreateText(levelRow.transform, "XP", "0 / 100 XP", 18f, theme.textSecondary);
            playerXPText.GetOrAddComponent<LayoutElement>().preferredWidth = 150;
            
            // XP Progress bar
            var xpBarBg = UIFactory.CreatePanel(statsPanel.transform, "XPBarBg", theme.backgroundColor);
            xpBarBg.GetOrAddComponent<LayoutElement>().preferredHeight = 15;
            ...
            playerCoinsText.GetOrAddComponent<LayoutElement>().preferredHeight = 25;
        ...
        private void BuildAreaDetailPanel()
        {
            ...
            backBtn.GetOrAddComponent<LayoutElement>().preferredHeight = 45;
            
            // Area name
            areaNameText = UIFactory.CreateTitle(areaDetailPanel.transform, "AreaName", "Area Name", 36f);
            areaNameText.GetOrAddComponent<LayoutElement>().preferredHeight = 50;
            
            // Area description
            areaDescriptionText = UIFactory.CreateText(areaDetailPanel.transform, "AreaDesc", "", 18f, theme.textSecondary);
            areaDescriptionText.GetOrAddComponent<LayoutElement>().preferredHeight = 60;
            ...
            bossesTitle.GetOrAddComponent<LayoutElement>().preferredHeight = 35;
            
            // Boss list container
            var bossListScroll = UIFactory.CreatePanel(areaDetailPanel.transform, "BossListScroll", theme.backgroundColor);
            bossListScroll.GetOrAddComponent<LayoutElement>().flexibleHeight = 1;
        ...
        private void BuildBossDetailPanel()
        {
            ...
            bossNameText.GetOrAddComponent<LayoutElement>().preferredHeight = 60;
            ...
            bossDescriptionText.GetOrAddComponent<LayoutElement>().preferredHeight = 80;
            ...
            bossRequirementsText.GetOrAddComponent<LayoutElement>().preferredHeight = 40;
            ...
            rewardsTitle.GetOrAddComponent<LayoutElement>().preferredHeight = 35;
            rewardsTitle.color = theme.accentColor;
            
            bossRewardsText = UIFactory.CreateText(content.transform, "Rewards", "", 20f, theme.accentColor);
            bossRewardsText.GetOrAddComponent<LayoutElement>().preferredHeight = 60;
        ...
        private void OnWorldMapReceived(WorldMapState state)
        {
            ...
            playerXPText.text = $"{state.playerXP} / {state.xpForNextLevel ?? 100} XP";
        ...
        private GameObject CreateAreaButton(AreaInfo area, Vector2 position)
        {
            ...
            progressText.GetOrAddComponent<LayoutElement>().preferredHeight = 20;
        ...
        private void CreateBossListItem(BossListItem boss)
        {
            ...
            nameText.GetOrAddComponent<LayoutElement>().preferredWidth = 250;
            ...
            diffText.GetOrAddComponent<LayoutElement>().preferredWidth = 120;
            ...
            reqText.GetOrAddComponent<LayoutElement>().preferredWidth = 180;
            ...
            var challengeBtn = UIFactory.CreateButton(item.transform, "Challenge", boss.canChallenge ? "CHALLENGE" : "🔒", 
                () => ShowBossDetail(boss));
            challengeBtn.GetOrAddComponent<LayoutElement>().preferredWidth = 140;
